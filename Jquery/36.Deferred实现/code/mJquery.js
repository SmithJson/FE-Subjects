...
(function (w) {
    ...
    jQuery.myCallbacks = function () {
        ...
        function fire() {
            for (; firedIndex < list.length; firedIndex++) {
                list[firedIndex].apply(window, args);
            }
        ...
        return {
            add: function (func) {
                ...
                if (option.indexOf('memory') !== -1 && isFired) fire();
            },
            fire: function () {
                firedIndex = 0;
                args = arguments;
    ...
    jQuery.myDeferred = function () {
        ...
        for (let i = 0; i < len; i++) {
            ...
            df[arr[i][2]] = function () {
                ...
                if (pending) {
                    cb.fire.apply(window, arguments);
                    pending = !(arr[i][2] === 'resolve' || arr[i][2] === 'reject');
                }
            };
        }
