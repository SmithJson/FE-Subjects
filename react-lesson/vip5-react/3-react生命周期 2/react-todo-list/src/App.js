...
class App extends React.Component{
    constructor(props){
        ...
        let flag = Object.prototype.toString.call(todos) === '[object Array]' ? true : false;
        this.state = {
            todos: flag ? todos :eval(`${todos}`),
    ...
    allChecked() {         //全选函数，供子组件调用
        let isAllChecked = false;        // every() 方法用于检测数组所有元素是否都符合指定条件（通过函数提供）。
